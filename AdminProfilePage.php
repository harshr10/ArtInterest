...
<head> 
	...
	<link rel="stylesheet" type="text/css" href="css/AdminProfilePageStyle.css">
...
<div class="container">
		<div class="profile-header">
			...
			<div class="profile-nav-info">
				<h3 class="user-name"> <?php echo $row["First_Name"]; echo " " ; echo $row["Last_Name"]; ?> </h3>
				<div class="address">
					<p class="state"> <?php echo $row["State"]; ?> </p>
					<span class="country"> <?php echo $row["Country"]; ?> </span>
				</div>
				<form action="Database.php" method="post">
				<input type="submit" name="insert" value="Add Art" id="insert">
				<input type="submit" name="edit" value="Edit Art" id="edit">
				<input type="submit" name="delete" value="Delete Art" id="delete">
				</form>
			</div>
